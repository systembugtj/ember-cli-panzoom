...
export default Ember.Component.extend({
  ...
  disableXAxis: Ember.computed.alias("options.disableXAxis"),
  disableYAxis: Ember.computed.alias("options.disableYAxis"),
  which: Ember.computed.alias("options.which"),
  increment: Ember.computed.alias("options.increment"),
  linearZoom: Ember.computed.alias("options.linearZoom"),
  ...
  didInsertElement() {
    ...
    $panzoom.panzoom({
        ...
        disableXAxis: this.get("disableXAxis"),
        disableYAxis: this.get("disableYAxis"),
        which: this.get("which"),
        increment: this.get("increment"),
        linearZoom: this.get("linearZoom"),
